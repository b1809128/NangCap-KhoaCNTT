...
if (isset($_GET['bomon'])) {
    ...
    $sqlSearch = "SELECT * FROM `manage_post` WHERE BaiBaoKhoaHoc != ''  AND (MaCB LIKE '%$search%' OR BoMon LIKE '%$search%' OR GiangVienThamGia LIKE '%$search%' OR BaiBaoKhoaHoc LIKE'%$search%' OR TenGiangVien LIKE '%$search%' OR NamXuatBan LIKE '%$search%' OR TrangDongGop LIKE '%$search%');";
    ...
    $search = $_GET['search1'];
    if ($nam == "all") {
        $sqlNam1 = "SELECT * FROM `manage_post` WHERE BaiBaoKhoaHoc != '' AND BoMon LIKE '%$bomon%' AND ( MaCB LIKE '%$search%' OR TenGiangVien LIKE '%$search%');";
    } else {
        $sqlNam1 = "SELECT * FROM `manage_post` WHERE BaiBaoKhoaHoc != '' AND NamXuatBan LIKE '%$nam%' AND BoMon LIKE '%$bomon%' AND ( MaCB LIKE '%$search%' OR TenGiangVien LIKE '%$search%');";
    }
